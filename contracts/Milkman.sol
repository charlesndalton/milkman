...
contract Milkman {
    ...
    event SwapRequested(bytes32 swapHash, address orderContract);
    ...
    function requestSwapExactTokensForTokens(
        ...
        emit SwapRequested(_swapHash, _orderContract);
    }
    ...
    {
        GPv2Order.Data memory _order = abi.decode(
            _encodedOrder[:325],
            (GPv2Order.Data)
        );

        return (_order, address(0), bytes(""));
    }
