...
def test_request_swap(milkman, user, gno_whale, gno, dai, univ2_price_checker):
    ...
    check_swap_requested(milkman, user, user, gno, dai, amount, univ2_price_checker.address, 0)
...
def test_request_without_sufficient_tokens(milkman, user, gno, dai, univ2_price_checker):
    amount = 100e18
...
def check_swap_requested(milkman, user, receiver, from_token, to_token, amount, price_checker_address, nonce):
